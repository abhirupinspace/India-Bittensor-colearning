...
After Chutes provided **compute** (GPU inference), let's now look at the subnet that provides AI's **fuel**: **data**. Welcome to **Data Universe: NetUID 13**.
...
- 🗄️ Understand the **storage architecture**: why S3-compatible and how validators verify
- 📏 Understand the principles of **Data Universe scoring**: what factors lead to miner rewards
- 🚀 See why **SN13 is the best choice for beginner miners**: and this is what you'll build in Phase 2 GP-2
:::
...
Total entry cost can be **under $30/month**, much cheaper than Chutes.
:::
...
This is the **first** subnet whose miner we'll deploy in Phase 2.

➡️ **Phase 2: GP-2 (Guided Project 2): Data Universe (SN13) Mining** will walk you step-by-step through:
...
All the concepts in this unit: **freshness, desirability, S3 buckets, commitment hashes**: you'll execute with your own hands in Phase 2 GP-2. Make sure you understand them at the conceptual level now.

:::tip Pair It With SN41
We recommend every participant **try both**: SN41 (Sportstensor) to learn a revenue-generating prediction subnet, and SN13 to learn the most beginner-friendly data subnet. Next unit covers SN41.
:::
...
6. **This is the subnet you'll deploy in Phase 2 GP-2**: concepts in this unit translate directly.

### ✅ Quick Check

Before moving on to Unit 3 (Sportstensor), make sure you can answer:
