...
description: 'A curated collection of official Bittensor references: documentation, explorers, subnet repos, YouTube channels, testnet faucet, community channels, and a glossary of essential terms.'
slug: /resources
---
...
- Dedicated help channel for miner issues
- Job & grant board (Bittensor ecosystem hiring)
- Priority access to future CLCs
