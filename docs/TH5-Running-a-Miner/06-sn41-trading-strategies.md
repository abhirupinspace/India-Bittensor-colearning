...
:::note Prerequisites
- ✅ [SN41: Programmatic Trade Execution](./sn41-trade-execution) complete: baseline handler running
...
## Risk Management: Confidence Calibration
...
## Submission Evidence (SN41 Track)

Collect the following evidence into a `submission-sn41/` folder:
...
**Congratulations!**  You've finished the Sportstensor SN41 track. Continue to the SN13 Data Universe track to learn mining on the data-provision subnet:

**Next:** [Running the SN13 Miner →](./running-the-sn13-miner)
