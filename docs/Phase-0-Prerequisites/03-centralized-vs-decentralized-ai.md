...
> This unit is the **bridge** from Phase 0 to Bittensor. By the end you'll understand **"why Bittensor exists"** before we dig into **"how Bittensor works"** in Phase 1.
...
## ⚠️ Real Problems With Centralized AI
...
flowchart TB
    subgraph Network[🌐 Bittensor Network]
        M1[⛏️ Miner A<br/>GPU in Asia]
        M2[⛏️ Miner B<br/>GPU in USA]
        M3[⛏️ Miner C<br/>GPU in Europe]
        V1[⚖️ Validator]
        V2[⚖️ Validator]
    end
...
**Next:** [Unit 4: Why Does Bittensor Matter?](./why-bittensor) 👉

*You understand the context now. Time to zoom in on the main player you'll be learning about for the next two weeks: Bittensor.* 🦆
