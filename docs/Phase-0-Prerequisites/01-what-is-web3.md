...
> If you've never touched crypto, blockchain, or a wallet: **read this unit first.** Everything that follows assumes you understand the basics covered here.
...
```mermaid
flowchart TB
    A[👥 User A] -->|Transaction| B[(⛓️ Blockchain<br/>Public Ledger)]
...
We cover this in detail in **Phase 2 → GP-0 Unit 3 (Wallet Setup)**.
...
That's what Bittensor is building. We go deeper in [Unit 3: Centralized AI vs Decentralized AI](./centralized-vs-decentralized-ai).
...
**Next:** [Unit 2: What is AI?](./what-is-ai) 👉
