...
> If you're already familiar with ChatGPT and you understand the difference between "training" and "inference", you can skim this unit. Otherwise, **read it slowly**: these concepts are used throughout Phase 1.
...
## 🏋️ The Two Main AI Activities: Training & Inference

This is **a critical concept**: it will keep coming up in Bittensor. Memorize it.

### 1. 🏋️ Training: "The Learning Phase"

```mermaid
flowchart LR
    A[📚 Dataset<br/>Millions of examples] --> B[🧠 Empty Model]
    B --> C[⚙️ Training<br/>Runs on GPUs<br/>Hours, days, weeks]
...
- ⏱️ **Slow:** can take hours, days, or weeks
...
- ⏱️ **Fast:** milliseconds to seconds
...
AI is everywhere. The real question: **who controls it?** → That's exactly what we discuss in [Unit 3](./centralized-vs-decentralized-ai).

---

## ⚠️ AI Myths to Unlearn
