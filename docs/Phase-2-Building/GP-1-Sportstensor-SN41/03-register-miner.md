---
sidebar_position: 3
title: '⛏️ Register the Miner on SN41'
...
:::note Prerequisites
- ✅ [Unit 2: Wallet & TAO Funding](./02-wallet-tao-funding) complete
...
sequenceDiagram
    ...
    Note over U,BC: 🛡️ Immunity ~7200 blocks<br/>(~24 hours on mainnet)
...
After registering, you get an **immunity period** (~24 hours on mainnet). During this window you won't be deregistered even with a score of 0. Use this time to **set up the miner code** in units 4–6 and don't waste it.
:::
