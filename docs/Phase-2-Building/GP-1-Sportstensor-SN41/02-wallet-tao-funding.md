...
:::note Prerequisites
- ✅ Completed [Unit 1: Intro SN41](./01-intro-sn41)
...
2. Withdraw TAO to your **coldkey SS58 address**.
   - ⚠️ Make sure the exchange supports **native Bittensor withdrawal** (not wrapped TAO on another network!)
