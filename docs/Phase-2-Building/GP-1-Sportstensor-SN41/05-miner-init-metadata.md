...
:::note Prerequisites
- ✅ [Unit 4: Almanac Registration](./04-almanac-registration) complete: binding succeeded
...
| `UID not in metagraph` | Not registered / deregistered | Go back to Unit 3 |
...
| Queries arrive but response times out | Your handler is too slow: tune in Unit 6 |
