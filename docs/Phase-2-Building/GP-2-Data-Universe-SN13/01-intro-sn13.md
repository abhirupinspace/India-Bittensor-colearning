...
- Understand why **data is the new oil** for AI training (callback to Phase 0 Unit 2)
...
- ✅ All of **Phase 0** (Web3, AI, Decentralized AI, Why Bittensor)
- ✅ **Phase 1 Concept I & II** (Core Concepts, Tokenomics, Core Subnets)
- ✅ **Phase 2 GP-1**: Sportstensor (SN41) up to a running miner
...
If you read Phase 0 Unit 2, you know that **modern AI (LLMs, vision, reasoning models) needs absurd amounts of data.** GPT-4 was trained on tens of TBs of text. LLaMA 3 used 15T tokens. Gemini needs a multimodal corpus: text + video + audio + code.
...
- Respond to validator queries via HTTP endpoint (interaction layer: covered in Unit 6)
...
## 📈 Scoring Glance (Full Detail in Unit 4)
...
## 🗺️ GP-2 6-Unit Roadmap

Here's the learning flow for the next 6 units:

```mermaid
flowchart LR
    U1[Unit 1<br/>SN13 Intro<br/>✅ You are here] --> U2[Unit 2<br/>Environment Setup]
...
Each unit has practical deliverables: by the end of Unit 6, you'll have a miner running 24/7 with real data uploaded to S3 and audited by validators.
