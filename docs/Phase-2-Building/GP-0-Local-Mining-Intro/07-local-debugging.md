...
- **[GP-1: Sportstensor SN41](../GP-1-Sportstensor-SN41/01-intro-sn41)** → CPU-friendly, sports prediction, can run from a laptop
- **[GP-2: Data Universe SN13](../GP-2-Data-Universe-SN13/01-intro-sn13)** → VPS recommended, data scraping, storage-heavy
