...
The showcase is where you demo what you built and mined. Keep it **lightning-talk style** — short, focused, and live where possible.

## Showcase Format

- **3–5 minutes** per participant
- **Live or recorded** demo of your miner running
- **1–2 slides max** (optional) — don't over-prepare
- **Q&A** — 1–2 quick questions from the room
