...
sidebar_position: 4
description: 'A short history of Bittensor, the founding team, the underlying philosophy, and why Bittensor is the leading player in Decentralized AI.'
---
...
3. **What subnets, miners, and validators are**: a first-pass overview before the deep dive
4. **Why 2026 is the right moment** to enter Bittensor
:::

> This page closes out the foundations. After this, you have all the context you need to start the technical deep dive.
...
## The Three Pillars of Bittensor

What makes Bittensor different from other Decentralized AI projects:

```mermaid
flowchart TB
    A[ Bittensor] --> B[1⃣ Incentive Layer<br/>TAO + Yuma Consensus]
    A --> C[2⃣ Subnet Architecture<br/>Modular Specialization]
    A --> D[3⃣ Peer-to-Peer Evaluation<br/>Validators Score Miners]
...
### 1⃣ Incentive Layer: "Work = Earn TAO"
...
### 2⃣ Subnet Architecture: "Specialization"
...
### 3⃣ Peer-to-Peer Evaluation: "Validators Score Miners"
...
## Quick Glossary (We'll Go Deeper Later)
...
**Don't panic** if you don't yet understand all of these. We'll cover each one as we go.
...
### Why This Camp is Particularly Relevant
...
From here, you'll move into the more technical material:
...
You **can lose money** if you go in without a strategy: registration fees, GPU costs, time costs. We cover this in the Tokenomics material.
...
- How does centralized AI differ from Bittensor?

---

## Ready for the Deep Dive?

**The foundations are complete!**  You now have a foundation:
- ✅ Web3 (blockchain, wallet, token)
- ✅ AI (training, inference, model, LLM)
- ✅ Why Decentralized AI matters
- ✅ Where Bittensor sits in the DeAI ecosystem

**Next:** [Ecosystem Overview](/TH1-Foundations-and-Introduction/ecosystem-overview)
