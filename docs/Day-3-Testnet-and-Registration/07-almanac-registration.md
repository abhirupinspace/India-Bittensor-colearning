---
title: 'Almanac Registration & Identity Binding'
...
:::note Prerequisites
- ✅ [Unit 3: Register the Miner on SN41](./register-miner) complete: UID assigned
...
# Install dependencies in the same venv from Unit 2
...
If the miner is already running (we'll do that in Unit 5):
...
- **Fix:** go back to [Unit 3](./register-miner) and confirm the UID is assigned.
...
**Next:** [Unit 5: Miner Initialization & Metadata Registration →](../Day-4-Mining-and-Optimization/miner-init-metadata)
